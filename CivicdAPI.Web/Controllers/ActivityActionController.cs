...
namespace CivicdAPI.Controllers
{
    [Authorize]
    [Route("api")]
    public class ActivityActionController : ControllerBase
    {
        /// <summary>
        /// Get Activity by Id
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        //[SwaggerResponse(HttpStatusCode.OK, Type = typeof(ActivityDTO))]k
        ...
        [HttpGet]
        public ActionResult GetByTag(string tagName)
        {
            using (var db = new ApplicationDbContext())
            {
        ...
        [HttpGet]
        [Route("activities")]
        public ActionResult GetByDateRange(DateTime? startDate = null, DateTime? endDate = null)
        {
            using (var db = new ApplicationDbContext())
            {
       ...
       // [SwaggerResponse(HttpStatusCode.OK, Type = typeof(ActivityDTO))]
        ...
        public ActionResult GetByOrganization(string organizationUserName)
        {
            using (var db = new ApplicationDbContext())
            {
       ...
       // [SwaggerResponse(HttpStatusCode.OK, Type = typeof(ActivityDTO))]
        ...
        public ActionResult RSVP(int activityId, string userName)
        {
            ...
            using (var context = new ApplicationDbContext())
            {
                ...
                if (!User.IsInRole("Admin") && User.Identity.Name != user.Id)
                {
        ...
        public ActionResult CheckInActivity(int activityId, string userName)
        {
            using (var context = new ApplicationDbContext())
            {
                var user = context.Users.FirstOrDefault(u => u.UserName == userName);
       ...
       // [SwaggerResponse(HttpStatusCode.OK, Type = typeof(ActivityDTO))]
        ...
        public ActionResult UpdateActivity(int activityId, ActivityDTO activity)
        {
            using (var context = new ApplicationDbContext())
            {
                var loggedInUser = User.Identity.Name;
